...
- [尚硅谷大数据项目之电商数仓（3电商数据仓库系统）V6.2.4.docx](./sgg-word/尚硅谷大数据项目之电商数仓（3电商数据仓库系统）V6.2.4.docx)
- [尚硅谷大数据项目之电商数仓（4可视化报表）.doc](./sgg-word/尚硅谷大数据项目之电商数仓（4可视化报表）.doc)
- [尚硅谷大数据项目之电商数仓（5即席查询Presto&Kylin）.docx](./sgg-word/尚硅谷大数据项目之电商数仓（5即席查询Presto&Kylin）.docx)
- [尚硅谷大数据项目之电商数仓（6集群监控Zabbix）V6.2.0.doc](./sgg-word/尚硅谷大数据项目之电商数仓（6集群监控Zabbix）V6.2.0.doc)
---
- [尚硅谷大数据项目之电商数仓（1用户行为采集平台）.pdf](./sgg-pdf/尚硅谷大数据项目之电商数仓（1用户行为采集平台）.pdf)
- [尚硅谷大数据项目之电商数仓（2业务数据采集平台）.pdf](./sgg-pdf/尚硅谷大数据项目之电商数仓（2业务数据采集平台）.pdf)
- [尚硅谷大数据项目之电商数仓（3电商数据仓库系统）V6.2.4.pdf](./sgg-pdf/尚硅谷大数据项目之电商数仓（3电商数据仓库系统）V6.2.4.pdf)
